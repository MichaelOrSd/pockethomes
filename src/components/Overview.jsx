  ...
  return (
    <div className='max-w-[1400px] m-auto py-8 px-4 grid lg:grid-cols-2 gap-4'>
        ...
        <div className='flex flex-col h-full justify-center'>
            <h3 className='text-5xl md:text-6xl font-bold'>Pocket Community Concept</h3>
            <p className='text-2xl py-6'>This conceptual project aims to support community living while prioritizing sustainability and affordability.</p>
